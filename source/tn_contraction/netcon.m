function [sequence,cost,subnet_sequence,subnet_tensors] = netcon(legLinks,verbosity,costType,muCap,allowOPs,legCosts)
...
% Corrected helptext.
    ...
    subnet_tensors = cell(1,subnetcounter);
    ...
    for a=1:subnetcounter
        if verbosity > 0
            ...
            subnet_tensors{a} = find(subnetlist==a);
            if verbosity > 1
